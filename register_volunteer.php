...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $course= $_POST['course'];
    $army= $_POST['army'];
    $sql = "INSERT INTO volunteer (c_first_name, c_last_name, c_password1, c_id, c_gender, c_phone, c_mail, c_country, c_city, c_status, c_date, c_edu, c_exp, c_course, c_army)
    VALUES ('$first_name', '$last_name', '$password1', '$id', '$gender', '$phone', '$mail', '$country', '$city', '$status', '$date', '$edu', '$exp', '$course', '$army' )";
    $mysqli->query($sql);
...
<div class="container sign_in">
    ...
    <h1 id="white">Volunteer Registration</h1>      
  </div>
        ...
        <div class="form-group" >
            <input type="text" class="form-control" placeholder="Higher Education" name="edu">
        </div>
        <div class="form-group" >
            <input type="text" class="form-control" placeholder="Experience" name="exp">
        </div>
        <div class="form-group" >
            <input type="text" class="form-control" placeholder="Courses & Diploma" name="course">
        </div>
        <div class="form-group" >
            <input type="text" class="form-control" placeholder="Courses and Diploma" name="army">
        </div>
        <div class="form-group">        
